                    ...
                    <div className="lg:flex lg:flex-row gap-5 w-11/12 shadow-2xl bg-teal-800 md:h-[95%] md:overflow-hidden rounded-xl">
                        <div className="md:w-1/2 flex flex-col items-center">
                            ...
                            <div>
                                ...
                                <div className="flex">
                                    <a id="tweet-quote" title="Tweet this quote" className="shareQuotes" href={`https://twitter.com/intent/tweet?text="${query.data?.title}" - https://mememachine.vercel.app/posts/${router.query.id}`} target="_blank">
