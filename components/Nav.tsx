    ...
    return (
        <nav>
            ...
            {user ?
                ...
                : <Link href={"/auth/"} >
                    <a className="navLinks">
                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" className="bi bi-door-open" viewBox="0 0 16 16">
            ...
            <Link href={'/search'} >
                <a className="navLinks">
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
